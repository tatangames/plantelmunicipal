...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('sistema2/proveedores/listado-tabla') }}";
    ...
    <script>
        ...
        function nuevo(){
            ...
            axios.post(url+'/sistema2/proveedores/listado-nuevo', formData, {
            })
                .then((response) => {
                    closeLoading()
        ...
        function recargar(){
            var ruta = "{{ url('sistema2/proveedores/listado-tabla') }}/";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function modalInformacion(id){
            ...
            axios.post(url+'/sistema2/proveedores/listado-info',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/sistema2/proveedores/listado-editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success == 1){
