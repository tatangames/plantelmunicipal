...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('tipos/listado-tabla') }}";
    ...
    <script>
        ...
        function verificar(){
            ...
            axios.post('/tipos/listado-nuevo', formData, {
            })
                .then((response) => {
        ...
        function recargar(){
            var ruta = "{{ url('/tipos/listado-tabla') }}/";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function editar(){
            ...
            axios.post('/tipos/listado-editar', formData, {
            })
                .then((response) => {
                    if(response.data.success === 1){
