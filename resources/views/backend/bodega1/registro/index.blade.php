...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('materiales/listado-tabla') }}";
    ...
    <script>
        ...
        function verificar(){
            ...
            axios.post('/materiales/listado-nuevo', formData, {
            })
                .then((response) => {
        ...
        function recargar(){
            var ruta = "{{ url('/materiales/listado-tabla') }}/";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function modalInformacion(id){
            ...
            axios.post('/materiales/listado-info',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post('/materiales/listado-editar', formData, {
            })
                .then((response) => {
        ...
        function historialIngreso(id){
            window.location.href="{{ url('/materiales/histo/ingreso') }}/"+id;
        }

        // ver lista de retiros de un material por id
        function historialRetiro(id){
            window.location.href="{{ url('/materiales/histo/retiro') }}/"+id;
        }
