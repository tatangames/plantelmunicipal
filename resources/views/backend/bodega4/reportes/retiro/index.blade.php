...
<section class="content-header">
    ...
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Reporte de Bodega (Retiro)</h3>
        </div>
        <div class="card-body">
        ...
        <div class="card-footer">
            <button type="button"  class="btn btn-success" onclick="verificar1();">Reporte Separado</button>
        </div>

        <div class="card-footer">
            <button type="button"  class="btn btn-success" onclick="verificar2();">Reporte Fila</button>
        </div>
...
@section('archivos-js')
    ...
    <script>
        ...
        function verificar1(){
            ...
            window.open("{{ URL::to('sistema4/reportes/bodega4/retiro') }}/" + fechadesde + "/" + fechahasta);
        }
        ...
        function verificar2(){
            ...
            window.open("{{ URL::to('sistema4/reportes/bodega4/retiro-fila/') }}/" + fechadesde + "/" + fechahasta);
        }
