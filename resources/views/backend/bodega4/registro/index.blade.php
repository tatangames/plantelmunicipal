                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="300" class="form-control" id="codigo-nuevo">
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Descripción</label>
                                        <input type="text" maxlength="300" class="form-control" id="codigo-editar">
                                    </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('sistema4/materiales/listado-tabla') }}";
    ...
    <script>
        ...
        function verificar(){
            ...
            if(codigo.length > 300){
                toastMensaje('error', '300 caracteres máximo para Código');
                return;
            }
            ...
            axios.post(url+'/sistema4/materiales/ingreso/nuevo', formData, {
            })
                .then((response) => {
        ...
        function recargar(){
            var ruta = "{{ url('sistema4/materiales/listado-tabla') }}/";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function modalInformacion(id){
            ...
            axios.post(url+'/sistema4/materiales/listado-info',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/sistema4/materiales/listado-editar', formData, {
            })
                .then((response) => {
        ...
        function historialIngreso(id){
            window.location.href="{{ url('sistema4/materiales/histo/ingreso') }}/"+id;
        }

        // ver lista de retiros de un material por id
        function historialRetiro(id){
            window.location.href="{{ url('sistema4/materiales/histo/retiro') }}/"+id;
        }
