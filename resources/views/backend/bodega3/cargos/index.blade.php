...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('sistema3/cargos/listado-tabla') }}";
    ...
    <script>
        ...
        function verificar(){
            ...
            axios.post(url+'/sistema3/cargos/listado-nuevo', formData, {
            })
                .then((response) => {
        ...
        function recargar(){
            var ruta = "{{ url('sistema3/cargos/listado-tabla') }}/";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function modalInformacion(id){
            ...
            axios.post(url+'/sistema3/cargos/listado-info',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/sistema3/cargos/listado-editar', formData, {
            })
                .then((response) => {
                    if(response.data.success === 1){
