        ...
        <div class="container-fluid">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">Listado de Encargados</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('sistema3/encargados/listado-tabla') }}";
    ...
    <script>
        ...
        function nuevo(){
            ...
            axios.post(url+'/sistema3/encargados/listado-nuevo', formData, {
            })
                .then((response) => {
                    closeLoading()
        ...
        function recargar(){
            var ruta = "{{ url('sistema3/encargados/listado-tabla') }}/";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function modalInformacion(id){
            ...
            axios.post(url+'/sistema3/encargados/listado-info',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/sistema3/encargados/listado-editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
